                  ...
                  <Suspense fallback={<PageSkeleton />}>
                    <Routes>
                      ...
                      <Route
                        ...
                        element={
                          <SaaSProtectedRoute allowedRoles={["ADMIN", "SALES"]}>
                            <SaaSLayout title="CRM & Khách Hàng Tiềm Năng">
                              <SaaSCRMPage />
                            </SaaSLayout>
                          </SaaSProtectedRoute>
                        }
                      ...
                      <Route
                        ...
                        element={
                          <SaaSProtectedRoute allowedRoles={["ADMIN", "PURCHASING", "WAREHOUSE"]}>
                            <SaaSLayout title="Mua Hàng & Quản Lý Đơn Mua PO">
                              <SaaSPurchasingPage />
                            </SaaSLayout>
                          </SaaSProtectedRoute>
                        }
                      ...
                      <Route
                        ...
                        element={
                          <SaaSProtectedRoute allowedRoles={["ADMIN", "ACCOUNTANT"]}>
                            <SaaSLayout title="Quản Lý Tài Sản Cố Định (TT200)">
                              <SaaSAssetsPage />
                            </SaaSLayout>
                          </SaaSProtectedRoute>
                        }
                      ...
                      <Route
                        ...
                        element={
                          <SaaSProtectedRoute allowedRoles={["ADMIN"]}>
                            <SaaSLayout title="Nhật Ký Thao Tác & An Ninh (Audit Trail)">
                              <SaaSAuditLogsPage />
                            </SaaSLayout>
                          </SaaSProtectedRoute>
                        }
